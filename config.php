...
### Database config
$config['db_host'] = "ip_of_central_server";
...
$config['distributed_poller_name']           = "monitoring.domain.lan"; # Set your own poller name
$config['distributed_poller_group']          = '0'; # Set the id, according to the group you created in central 
$config['distributed_poller_memcached_host'] = "ip_of_central_server";
$config['distributed_poller_memcached_port'] = 11211;
$config['distributed_poller']                = true;
$config['rrdcached']                         = "ip_of_central_server:42217";
